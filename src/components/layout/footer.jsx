  ...
  <div class="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
    <div class="mx-auto max-w-prose text-center">
      ...
      <p class="mt-4 text-pretty text-gray-700 dark:text-gray-200">
       Join our mailing list and get news about newly imported gadgets
      </p>
    </div>
    ...
    <form action="#" class="mx-auto mt-6 flex max-w-xl flex-col gap-4 sm:flex-row sm:items-center sm:justify-center">
      <label for="Email" class="flex-1">
       ...
       <input id="Email" type="email" name="Email" placeholder="Enter you email" class="block min-w-0 grow bg-gray-800 py-1.5 pr-3 pl-1 text-base text-white placeholder:text-gray-500 focus:outline-none sm:text-sm/6" />
      </label>
  ...
  <div class="mx-auto max-w-7xl space-y-8 px-4 py-16 sm:px-6 lg:space-y-16 lg:px-8">
    <div class="sm:flex sm:items-center sm:justify-between">
      <div class="text-teal-600">
       For more information vist our sites
      </div>
